      ...
      {(initialLoading || isCreatingGame) ? (
        ...
        <div className="container mx-auto py-10">
          <Card>
            <CardContent className="p-10">
              <h2 className="text-xl mb-4">No active game found</h2>
              <p className="mb-4">There doesn't seem to be an active game session.</p>
        ...
        <div className="container mx-auto py-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-lg shadow-sm h-[70vh] flex flex-col">
              <ChatInterface />
            </div>
            <div className="lg:col-span-1 h-[70vh] overflow-y-auto pr-2">
              <CharacterSheet />
            </div>
          </div>
        </div>
